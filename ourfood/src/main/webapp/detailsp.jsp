	...
	$(function() {
		$('.title-list li').click(
				function() {
					...
					$('.menutab-wrap div.menutab').eq(liindex).fadeIn(150)
							.siblings('div.menutab').hide();
...
<body>
	...
	<section class="slp">
		<section class="food-hd">
			<div class="foodpic">
				<img src="images/${fdetail.fphoto }" id="showimg">
				<ul class="smallpic">
					<li><img src="images/${fdetail.fphoto }"
						onmouseover="show(this)" onmouseout="hide()"></li>
				</ul>
			</div>
			<div class="foodtext">
				...
				<form action="cart.do">
					<div class="BuyNo">
						<span>我要买：<input type="number" name="number" required
							autofocus min="1" value="1" />份
						</span>
						<div class="Buybutton">
		...
		<section class="Bcontent">
			...
			<aside>
				<!--广告位或推荐位-->
				<a href="#" title="广告位占位图片" target="_blank"><img
					src="upload/2014912.jpg"></a>
			</aside>
		</section>
	</section>
	<!--End content-->
