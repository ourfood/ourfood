...
<header>
 <section class="Topmenubg">
  <div class="Topnav">
   ...
   <div class="RightNav">
    <a href="user_center.jsp">用户中心</a> <a href="user_orderlist.jsp" target="_blank" title="我的订单">我的订单</a> <a href="cart.jsp">购物车（0）</a>  
   </div>
  </div>
 </section>
 ...
 <div class="gwc" style=" margin:auto;">
  ...
  <table cellpadding="0" cellspacing="0" class="gwc_tb2" id="table1">
    <tr>
      ...
      <td class="tb2_td2"><a href="detailsp.jsp" target="_blank"><img src="upload/01.jpg"/></a></td>
  ...
  <table cellpadding="0" cellspacing="0" class="gwc_tb3">
    <tr>
      ...
      <td class="tb3_td4"><span id="jz1">结算</span><a href="confirm_order.jsp" style=" display:none;"  class="jz2" id="jz2">结算</a></td>
    </tr>
  </table>
</div>
</form>
